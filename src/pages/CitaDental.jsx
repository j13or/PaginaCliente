...
import "./pagesStyle/CitaDental.css";
...
const CitaDental = () => {
  ...
  return (
    <div className="CitaDental_comtainer">
      <img src="./1.jpg" alt="" className="CitaDental_image1" />
      <h1>Solicita Una Cita</h1>
      <form className="CitaDental_form" onSubmit={handleSubmit(submit)}>
